...
namespace forumhulp\uploadstyle;
...
class ext extends \phpbb\extension\base
{
	public function is_enableable()
	{
		...
		{
			$this->container->get('user')->add_lang_ext('forumhulp/uploadstyle', 'info_acp_uploadstyle');
	...
	public function enable_step($old_state)
	{
		if (empty($old_state))
		{
			...
			$this->container->get('template')->assign_var('L_EXTENSION_ENABLE_SUCCESS', $this->container->get('user')->lang['EXTENSION_ENABLE_SUCCESS'] .
				(isset($this->container->get('user')->lang['UPLOADSTYLE_NOTICE']) ?
				sprintf($this->container->get('user')->lang['UPLOADSTYLE_NOTICE'],
						$this->container->get('user')->lang['ACP_CAT_CUSTOMISE'],
						$this->container->get('user')->lang['ACP_STYLE_MANAGEMENT'],
						$this->container->get('user')->lang['ACP_STYLE_EXT_TITLE']) : ''));
		}
